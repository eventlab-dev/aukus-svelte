...
export const playerMovesData: PlayerMove[] = [
  {
    ...
    cell_to: 3,
    cell_from: 0,
    item_review: '{"type":"doc","content":[{"type":"paragraph","content":[{"type":"text","text":"Игра отличная для своего жанра (АНИМЕ-ПЛАТФОРМЕР-ГОЛОВОЛОМКА НАХУЙ), 10 НЯ из 10, да...."},{"type":"image","attrs":{"src":"https://cdn.7tv.app/emote/01K1KQ1X1M8K7XME2MZVDRMKRS/1x.avif","alt":null,"title":null,"width":null,"height":null}}]}]}',
    item_rating: 5,
    stair_from: null,
    stair_to: null,
    snake_from: null,
...

  {
    ...
    cell_to: 3,
    cell_from: 0,
    item_review: '{"type":"doc","content":[{"type":"paragraph","content":[{"type":"text","text":"Игра отличная для своего жанра (АНИМЕ-ПЛАТФОРМЕР-ГОЛОВОЛОМКА НАХУЙ), 10 НЯ из 10, да...."}]}]}',
    item_rating: 5,
    stair_from: null,
    stair_to: null,
    snake_from: null,
