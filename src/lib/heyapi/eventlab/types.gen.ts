...
/**
 * AuctionStartedNotificationItem
 */
export type AuctionStartedNotificationItem = {
    /**
     * Id
     */
    id: number;
...
/**
 * AuctionWinnerNotificationItem
 */
export type AuctionWinnerNotificationItem = {
    /**
     * Id
     */
    id: number;
    ...
    payload: AuctionWinnerPayload;
};

/**
 * AuctionWinnerPayload
 */
...
/**
 * CategoryChangedNotificationItem
 */
export type CategoryChangedNotificationItem = {
    /**
     * Id
     */
    id: number;
     ...
     * Notification Type
     */
    notification_type: 'category_changed';
    payload: CategoryChangedPayload;
};
 ...
 * NotificationType
 */
export type NotificationType = 'user_online' | 'auction_started' | 'auction_winner' | 'category_changed' | 'player_move';
 ...
 * PlayerMoveNotificationItem
 */
export type PlayerMoveNotificationItem = {
    /**
     * Id
     */
    id: number;
 ...
 * UserOnlineNotificationItem
 */
export type UserOnlineNotificationItem = {
    /**
     * Id
     */
    id: number;
...
export type GetNotificationsApiNotificationsGetData = {
    ...
    query?: {
        /**
         * Since Timestamp
         * Get notifications after this timestamp
         */
